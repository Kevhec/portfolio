...
export const ui: UI = {
  en: {
    ...
    'about.1': "I'm a ",
    'about.2': '-year-old developer. ',
    'about.3': 'I love sharing what I know. ',
    'about.4': "That's why I started working on the frontend to create a blog, a platform to share science and provide educational resources for everyone, ",
    'about.5': 'no matter their ages or disabilities. ',
    'about.6': 'Along the way, ',
    'about.7': 'I discovered a passion for web development',
    'about.8': 'The constant learning opportunities captivated me. I am driven by the ambition of applying newfound knowledge',
    'about.9': 'to enhance the web and make it a more user-friendly space.',
